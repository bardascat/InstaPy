...
def getPostsByHashtag(hashtag, amount, id_campaign, removeLikedPosts, removeFollowedUsers):
    ...
    #logger = getLogger()
    print("crawler.getPostsByHashtag: Going to search posts by hashtag with options: hashtag: %s, amount: %s, id_campaign: %s" % (hashtag, amount, id_campaign))
...
def getPostsByLocation(location, amount, id_campaign, removeLikedPosts, removeFollowedUsers):
    ...
    #logger = getLogger()
    print("crawler.getPostsByHashtag: Going to search posts by location with options: location: %s, amount: %s, id_campaign: %s" % (location, amount, id_campaign))
